...
```{r, fig.width = 8}
  ...
  knitr::include_graphics(paste0(proj, "/collapsability/pics/fig_1_a.JPG"))
...
```{r, fig.width = 8}
  ...
  knitr::include_graphics(paste0(proj, "/collapsability/pics/fig_1_b.JPG"))
...
```{r}
knitr::include_graphics(paste0(proj, "/collapsability/pics/eq_1.JPG"))
```
